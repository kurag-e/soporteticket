...
public class SoporteDTO {
    ...
    // Constructor
    public SoporteDTO(Long idTicket, Long idUsuario, String tipoTicket, String descripcion, String estado, LocalDateTime fechaCreacion, LocalDateTime fechaResolucion) {
